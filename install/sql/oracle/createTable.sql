    drop table D_GOOD_THESISES cascade constraints;
    drop table D_THESIS_ANNOTATE_EVALUATES cascade constraints;
    drop table D_THESIS_DOCUMENT_NOTICES cascade constraints;
    drop table D_THESIS_DOCUMENT_TACHES cascade constraints;
    drop table D_THESIS_NOTICE_DEPARTS cascade constraints;
    drop table D_THESIS_PROCESS_ACTIVETYPE cascade constraints;
    drop table D_THESIS_PROCESS_STDS cascade constraints;
    drop table Q_EVA_TEACH_REMESSAGE cascade constraints;
    drop table Q_EVA_TEA_REM_STDS cascade constraints;
    drop table ST_DA_APPLIES cascade constraints;
    drop table ST_DA_ITEM_RESULTS cascade constraints;
    drop table ST_DA_LOGS cascade constraints;
    drop table ST_DA_SEASONS cascade constraints;
    drop table ST_DA_SEASONS_DEPARTMENTS cascade constraints;
    drop table ST_DA_SEASONS_DIRECTIONS cascade constraints;
    drop table ST_DA_SEASONS_EDUCATIONS cascade constraints;
    drop table ST_DA_SEASONS_MAJORS cascade constraints;
    drop table ST_DA_SEASONS_SEASONS cascade constraints;
    drop table ST_DA_SEASONS_STD_TYPES cascade constraints;
    drop table ST_DA_STANDARDS cascade constraints;
    drop table ST_DA_STANDARDS_DEPARTMENTS cascade constraints;
    drop table ST_DA_STANDARDS_DIRECTIONS cascade constraints;
    drop table ST_DA_STANDARDS_EDUCATIONS cascade constraints;
    drop table ST_DA_STANDARDS_MAJORS cascade constraints;
    drop table ST_DA_STANDARDS_RULE_CFGS cascade constraints;
    drop table ST_DA_STANDARDS_STD_TYPES cascade constraints;
    drop table ST_GA_ITEM_RESULTS cascade constraints;
    drop table ST_GA_LOGS cascade constraints;
    drop table ST_GA_RESULTS cascade constraints;
    drop table ST_GA_SEASONS cascade constraints;
    drop table ST_GA_STANDARDS cascade constraints;
    drop table ST_GA_STANDARDS_DEPARTMENTS cascade constraints;
    drop table ST_GA_STANDARDS_DIRECTIONS cascade constraints;
    drop table ST_GA_STANDARDS_EDUCATIONS cascade constraints;
    drop table ST_GA_STANDARDS_MAJORS cascade constraints;
    drop table ST_GA_STANDARDS_RULE_CFGS cascade constraints;
    drop table ST_GA_STANDARDS_STD_TYPES cascade constraints;
    drop table ST_PA_COURSE_RESULTS cascade constraints;
    drop table ST_PA_GROUP_RESULTS cascade constraints;
    drop table ST_PA_LOGS cascade constraints;
    drop table ST_PA_RESULTS cascade constraints;
    drop table ST_PA_STANDARDS cascade constraints;
    drop table ST_PA_STANDARDS_CONVERTABLES cascade constraints;
    drop table ST_PA_STANDARDS_DEPARTMENTS cascade constraints;
    drop table ST_PA_STANDARDS_DIRECTIONS cascade constraints;
    drop table ST_PA_STANDARDS_DISAUDITS cascade constraints;
    drop table ST_PA_STANDARDS_EDUCATIONS cascade constraints;
    drop table ST_PA_STANDARDS_MAJORS cascade constraints;
    drop table ST_PA_STANDARDS_STD_TYPES cascade constraints;
    drop table SYS_MSG_CFG_CATEGORIES cascade constraints;
    drop table T_BOOKORDER_CONFIGS_SEMESTERS cascade constraints;
    drop table T_BOOK_REQ_CONFIGS_SEMESTERS cascade constraints;
    drop table T_CONS_COURS_TYPE_MAX_COUNT cascade constraints;
    drop table T_COURSE_TYPE_CREDIT_CONS cascade constraints;
    drop table T_ELECT_PROFIES_ELECT_CFGS cascade constraints;
    drop table T_ELECT_PROFIES_ELECT_LESSONS cascade constraints;
    drop table T_ELECT_PROFIES_GENERAL_CFGS cascade constraints;
    drop table T_ELECT_PROFIES_WD_LESSONS cascade constraints;
    drop table T_ELECT_PROFIES_WITHDRAW_CFGS cascade constraints;
    drop table T_ELECT_PROFILES_EDUCATIONS cascade constraints;
    drop table T_ELECT_PROFILES_PROJECTS cascade constraints;
    drop table T_EXAM_APPLY_PARAM cascade constraints;
    drop table T_LESSON_FOR_D_L_IDS cascade constraints;
    drop table T_MAJOR_PLAN_CG_MODIFIES cascade constraints;
    drop table T_MAJOR_PLAN_CG_MOD_AFTERS cascade constraints;
    drop table T_MAJOR_PLAN_CG_MOD_BEFORS cascade constraints;
    drop table T_MAJOR_PLAN_C_MODIFIES cascade constraints;
    drop table T_MAJOR_PLAN_C_MOD_AFTERS cascade constraints;
    drop table T_MAJOR_PLAN_C_MOD_AFT_C_H cascade constraints;
    drop table T_MAJOR_PLAN_C_MOD_BEFORS cascade constraints;
    drop table T_MAJOR_PLAN_C_MOD_BEF_C_H cascade constraints;
    drop table T_MA_COURSE_SUBS cascade constraints;
    drop table T_MA_COURSE_SUBS_ORIGS cascade constraints;
    drop table T_MA_COURSE_SUBS_SUBS cascade constraints;
    drop table T_MA_PLAN_COURSES cascade constraints;
    drop table T_MA_PLAN_C_GROUPS cascade constraints;
    drop table T_MA_PLAN_C_GROUPS_REQ_CORS cascade constraints;
    drop table T_MA_PLAN_C_GROUPS_XCL_CORS cascade constraints;
    drop table T_ORI_PLANS cascade constraints;
    drop table T_ORI_PLAN_COURSES cascade constraints;
    drop table T_ORI_PLAN_C_GROUPS cascade constraints;
    drop table T_ORI_PLAN_C_GROUPS_REQ_CORS cascade constraints;
    drop table T_ORI_PLAN_C_GROUPS_XCL_CORS cascade constraints;
    drop table T_PER_PLANS cascade constraints;
    drop table T_PER_PLAN_COURSES cascade constraints;
    drop table T_PER_PLAN_C_GROUPS cascade constraints;
    drop table T_PER_PLAN_C_GROUPS_REQ_CORS cascade constraints;
    drop table T_PER_PLAN_C_GROUPS_XCL_CORS cascade constraints;
    drop table T_SHR_PLANS cascade constraints;
    drop table T_SHR_PLAN_COURSES cascade constraints;
    drop table T_SHR_PLAN_C_GROUPS cascade constraints;
    drop table T_STD_COURSE_COUNT_CONS cascade constraints;
    drop table T_STD_COURSE_SUBS cascade constraints;
    drop table T_STD_COURSE_SUBS_ORIGS cascade constraints;
    drop table T_STD_COURSE_SUBS_SUBS cascade constraints;
    drop table T_STD_TOTAL_CREDIT_CONS cascade constraints;
    drop table XB_EXCHANGE_TYPES cascade constraints;
    drop table XB_EXCH_SCHOOL_TYPES cascade constraints;
    drop table c_adminclasses cascade constraints;
    drop table c_adminclasses_instructors cascade constraints;
    drop table c_adminclasses_tutors cascade constraints;
    drop table c_building_course_units cascade constraints;
    drop table c_buildings cascade constraints;
    drop table c_calendars cascade constraints;
    drop table c_campuses cascade constraints;
    drop table c_classrooms cascade constraints;
    drop table c_classrooms_departments cascade constraints;
    drop table c_default_course_units cascade constraints;
    drop table c_departments cascade constraints;
    drop table c_direction_journals cascade constraints;
    drop table c_directions cascade constraints;
    drop table c_habilitations cascade constraints;
    drop table c_holidays cascade constraints;
    drop table c_major_journals cascade constraints;
    drop table c_majors cascade constraints;
    drop table c_majors_educations cascade constraints;
    drop table c_project_classrooms cascade constraints;
    drop table c_project_classrooms_departs cascade constraints;
    drop table c_project_classrooms_reserved cascade constraints;
    drop table c_project_codes cascade constraints;
    drop table c_project_configs cascade constraints;
    drop table c_project_properties cascade constraints;
    drop table c_projects cascade constraints;
    drop table c_projects_campuses cascade constraints;
    drop table c_projects_departments cascade constraints;
    drop table c_projects_educations cascade constraints;
    drop table c_projects_labels cascade constraints;
    drop table c_projects_time_settings cascade constraints;
    drop table c_projects_types cascade constraints;
    drop table c_schools cascade constraints;
    drop table c_semester_stages cascade constraints;
    drop table c_semesters cascade constraints;
    drop table c_staffs cascade constraints;
    drop table c_std_people cascade constraints;
    drop table c_student_journals cascade constraints;
    drop table c_students cascade constraints;
    drop table c_students_labels cascade constraints;
    drop table c_teacher_journals cascade constraints;
    drop table c_teachers cascade constraints;
    drop table c_time_settings cascade constraints;
    drop table cl_apply_time_units cascade constraints;
    drop table cl_occupancies cascade constraints;
    drop table cl_price_catalogs cascade constraints;
    drop table cl_price_catalogs_audit_departs cascade constraints;
    drop table cl_price_catalogs_prices cascade constraints;
    drop table cl_price_configs cascade constraints;
    drop table cl_room_applies cascade constraints;
    drop table cl_room_applies_classrooms cascade constraints;
    drop table cl_room_applies_occupations cascade constraints;
    drop table cl_room_usage_capacities cascade constraints;
    drop table course_modified_records cascade constraints;
    drop table course_modifieds cascade constraints;
    drop table d_thesis_active_types cascade constraints;
    drop table d_thesis_annotate_actives cascade constraints;
    drop table d_thesis_annotate_books cascade constraints;
    drop table d_thesis_annotate_filters cascade constraints;
    drop table d_thesis_annotate_teachers cascade constraints;
    drop table d_thesis_annotates cascade constraints;
    drop table d_thesis_answer_actives cascade constraints;
    drop table d_thesis_answer_filters cascade constraints;
    drop table d_thesis_answers cascade constraints;
    drop table d_thesis_coders cascade constraints;
    drop table d_thesis_documents cascade constraints;
    drop table d_thesis_evaluate_projects cascade constraints;
    drop table d_thesis_notices cascade constraints;
    drop table d_thesis_notices_documents cascade constraints;
    drop table d_thesis_pre_answer_actives cascade constraints;
    drop table d_thesis_pre_answer_filters cascade constraints;
    drop table d_thesis_pre_answers cascade constraints;
    drop table d_thesis_processes cascade constraints;
    drop table d_thesis_ranks cascade constraints;
    drop table d_thesis_sh_annotates cascade constraints;
    drop table d_thesis_sh_evaluations cascade constraints;
    drop table d_thesis_std_innovates cascade constraints;
    drop table d_thesis_teacher_evaluations cascade constraints;
    drop table d_thesis_teacher_innovates cascade constraints;
    drop table d_thesis_topic_open_actives cascade constraints;
    drop table d_thesis_topic_open_filters cascade constraints;
    drop table d_thesis_topic_opens cascade constraints;
    drop table d_thesis_topic_origins cascade constraints;
    drop table d_thesis_types cascade constraints;
    drop table d_thesis_undergraduate_actives cascade constraints;
    drop table d_thesis_undergraduate_filters cascade constraints;
    drop table d_thesis_undergraduates cascade constraints;
    drop table f_bill_logs cascade constraints;
    drop table f_bills cascade constraints;
    drop table f_check_fee_types cascade constraints;
    drop table f_pays cascade constraints;
    drop table f_tuitions cascade constraints;
    drop table gb_countries cascade constraints;
    drop table gb_degrees cascade constraints;
    drop table gb_divisions cascade constraints;
    drop table gb_genders cascade constraints;
    drop table gb_languages cascade constraints;
    drop table gb_marital_statuses cascade constraints;
    drop table gb_nations cascade constraints;
    drop table gb_politic_visages cascade constraints;
    drop table gb_social_relations cascade constraints;
    drop table gb_study_types cascade constraints;
    drop table gb_teacher_title_levels cascade constraints;
    drop table gb_teacher_titles cascade constraints;
    drop table hb_admission_types cascade constraints;
    drop table hb_attendance_types cascade constraints;
    drop table hb_book_award_types cascade constraints;
    drop table hb_course_take_types cascade constraints;
    drop table hb_education_modes cascade constraints;
    drop table hb_educations cascade constraints;
    drop table hb_election_modes cascade constraints;
    drop table hb_enroll_modes cascade constraints;
    drop table hb_exam_modes cascade constraints;
    drop table hb_exam_statuses cascade constraints;
    drop table hb_exam_types cascade constraints;
    drop table hb_examinee_types cascade constraints;
    drop table hb_family_economic_states cascade constraints;
    drop table hb_fee_origins cascade constraints;
    drop table hb_grade_types cascade constraints;
    drop table hb_graduate_states cascade constraints;
    drop table hb_hsch_grade_types cascade constraints;
    drop table hb_hskdegrees cascade constraints;
    drop table hb_idcard_types cascade constraints;
    drop table hb_other_exam_categories cascade constraints;
    drop table hb_other_exam_subjects cascade constraints;
    drop table hb_passport_types cascade constraints;
    drop table hb_pay_states cascade constraints;
    drop table hb_pay_types cascade constraints;
    drop table hb_press_levels cascade constraints;
    drop table hb_presses cascade constraints;
    drop table hb_production_award_levels cascade constraints;
    drop table hb_production_award_types cascade constraints;
    drop table hb_production_types cascade constraints;
    drop table hb_publication_grades cascade constraints;
    drop table hb_publications cascade constraints;
    drop table hb_railway_stations cascade constraints;
    drop table hb_residences cascade constraints;
    drop table hb_room_usages cascade constraints;
    drop table hb_score_mark_styles cascade constraints;
    drop table hb_std_alter_reasons cascade constraints;
    drop table hb_std_alter_types cascade constraints;
    drop table hb_std_award_types cascade constraints;
    drop table hb_std_punish_types cascade constraints;
    drop table hb_std_statuses cascade constraints;
    drop table hb_teach_lang_types cascade constraints;
    drop table hb_teach_modes cascade constraints;
    drop table hb_teacher_states cascade constraints;
    drop table hb_teacher_types cascade constraints;
    drop table hb_teacher_unit_types cascade constraints;
    drop table hb_tutor_types cascade constraints;
    drop table hb_uncheckin_reasons cascade constraints;
    drop table hb_unregister_reasons cascade constraints;
    drop table hb_visa_types cascade constraints;
    drop table jb_discipline_catalogs cascade constraints;
    drop table jb_discipline_categories cascade constraints;
    drop table jb_disciplines cascade constraints;
    drop table jb_institutions cascade constraints;
    drop table q_college_option_stats cascade constraints;
    drop table q_depart_evaluations cascade constraints;
    drop table q_department_option_stats cascade constraints;
    drop table q_eval_criteria_items cascade constraints;
    drop table q_evaluate_results cascade constraints;
    drop table q_evaluate_switches cascade constraints;
    drop table q_evaluation_criterias cascade constraints;
    drop table q_not_evaluate_students cascade constraints;
    drop table q_opposite_questions cascade constraints;
    drop table q_option_groups cascade constraints;
    drop table q_option_stats cascade constraints;
    drop table q_options cascade constraints;
    drop table q_question_detail_stats cascade constraints;
    drop table q_question_results cascade constraints;
    drop table q_question_type_stats cascade constraints;
    drop table q_question_types cascade constraints;
    drop table q_questionnaire_lessons cascade constraints;
    drop table q_questionnaire_stats cascade constraints;
    drop table q_questionnaire_stats_details cascade constraints;
    drop table q_questionnaire_stats_scores cascade constraints;
    drop table q_questionnaires cascade constraints;
    drop table q_questionnaires_oppo_qs cascade constraints;
    drop table q_questionnaires_questions cascade constraints;
    drop table q_questions cascade constraints;
    drop table q_teacher_option_stats cascade constraints;
    drop table q_text_eval_switches cascade constraints;
    drop table q_text_evaluations cascade constraints;
    drop table s_awards cascade constraints;
    drop table s_punishments cascade constraints;
    drop table s_std_abroads cascade constraints;
    drop table s_std_apply_edit_noteses cascade constraints;
    drop table s_std_contacts cascade constraints;
    drop table s_std_home_members cascade constraints;
    drop table s_std_homes cascade constraints;
    drop table s_student_apply_edits cascade constraints;
    drop table s_student_equivalents cascade constraints;
    drop table s_student_logs cascade constraints;
    drop table se_data_fields cascade constraints;
    drop table se_data_permissions cascade constraints;
    drop table se_data_resources cascade constraints;
    drop table se_data_types cascade constraints;
    drop table se_func_permissions cascade constraints;
    drop table se_func_resources cascade constraints;
    drop table se_members cascade constraints;
    drop table se_menu_profiles cascade constraints;
    drop table se_menus cascade constraints;
    drop table se_menus_resources cascade constraints;
    drop table se_profile_fields cascade constraints;
    drop table se_role_profiles cascade constraints;
    drop table se_role_properties cascade constraints;
    drop table se_roles cascade constraints;
    drop table se_session_profiles cascade constraints;
    drop table se_session_stats cascade constraints;
    drop table se_sessioninfo_logs cascade constraints;
    drop table se_sessioninfoes cascade constraints;
    drop table se_user_profiles cascade constraints;
    drop table se_user_properties cascade constraints;
    drop table se_users cascade constraints;
    drop table st_checkins cascade constraints;
    drop table st_register_user_groups cascade constraints;
    drop table st_register_user_groups_users cascade constraints;
    drop table st_registers cascade constraints;
    drop table st_report_login_switches cascade constraints;
    drop table st_std_admission_majors cascade constraints;
    drop table st_std_admissions cascade constraints;
    drop table st_std_alteration_items cascade constraints;
    drop table st_std_alterations cascade constraints;
    drop table st_std_edit_restrictions cascade constraints;
    drop table st_std_edit_restrictions_metas cascade constraints;
    drop table st_std_examinees cascade constraints;
    drop table st_std_examinees_scores cascade constraints;
    drop table st_std_graduations cascade constraints;
    drop table st_std_property_editors cascade constraints;
    drop table st_user_student_conditions cascade constraints;
    drop table sys_business_log_details cascade constraints;
    drop table sys_business_logs cascade constraints;
    drop table sys_code_categories cascade constraints;
    drop table sys_code_metas cascade constraints;
    drop table sys_code_scripts cascade constraints;
    drop table sys_entity_metas cascade constraints;
    drop table sys_manager_documents cascade constraints;
    drop table sys_manager_notices cascade constraints;
    drop table sys_message_contents cascade constraints;
    drop table sys_notice_contents cascade constraints;
    drop table sys_property_config_items cascade constraints;
    drop table sys_property_metas cascade constraints;
    drop table sys_report_templates cascade constraints;
    drop table sys_rule_config_params cascade constraints;
    drop table sys_rule_configs cascade constraints;
    drop table sys_rule_parameters cascade constraints;
    drop table sys_rules cascade constraints;
    drop table sys_student_documents cascade constraints;
    drop table sys_student_documents_departs cascade constraints;
    drop table sys_student_documents_std_types cascade constraints;
    drop table sys_student_notices cascade constraints;
    drop table sys_student_notices_departs cascade constraints;
    drop table sys_student_notices_std_types cascade constraints;
    drop table sys_system_message_configs cascade constraints;
    drop table sys_system_messages cascade constraints;
    drop table sys_teacher_documents cascade constraints;
    drop table sys_teacher_notices cascade constraints;
    drop table sys_wkhtmltopdf_paths cascade constraints;
    drop table t_arrange_suggests cascade constraints;
    drop table t_arrange_suggests_rooms cascade constraints;
    drop table t_available_times cascade constraints;
    drop table t_book_require_configs cascade constraints;
    drop table t_collision_resources cascade constraints;
    drop table t_constraint_loggers cascade constraints;
    drop table t_course_activities cascade constraints;
    drop table t_course_activities_rooms cascade constraints;
    drop table t_course_activities_teachers cascade constraints;
    drop table t_course_arrange_alters cascade constraints;
    drop table t_course_arrange_switches cascade constraints;
    drop table t_course_code_standards cascade constraints;
    drop table t_course_ext_infoes cascade constraints;
    drop table t_course_ext_infoes_teachers cascade constraints;
    drop table t_course_grade_states cascade constraints;
    drop table t_course_grades cascade constraints;
    drop table t_course_grades_exchanges cascade constraints;
    drop table t_course_hours cascade constraints;
    drop table t_course_limit_groups cascade constraints;
    drop table t_course_limit_items cascade constraints;
    drop table t_course_limit_metas cascade constraints;
    drop table t_course_mail_settings cascade constraints;
    drop table t_course_materials cascade constraints;
    drop table t_course_materials_books cascade constraints;
    drop table t_course_table_checks cascade constraints;
    drop table t_course_takes cascade constraints;
    drop table t_courses cascade constraints;
    drop table t_courses_ability_rates cascade constraints;
    drop table t_courses_majors cascade constraints;
    drop table t_courses_prerequisites cascade constraints;
    drop table t_courses_referbooks cascade constraints;
    drop table t_courses_textbooks cascade constraints;
    drop table t_courses_xmajors cascade constraints;
    drop table t_credit_award_criterias cascade constraints;
    drop table t_curriculum_change_applys cascade constraints;
    drop table t_elect_loggers cascade constraints;
    drop table t_elect_mail_templates cascade constraints;
    drop table t_elect_plans cascade constraints;
    drop table t_elect_plans_rule_configs cascade constraints;
    drop table t_election_profiles cascade constraints;
    drop table t_election_profiles_departs cascade constraints;
    drop table t_election_profiles_directions cascade constraints;
    drop table t_election_profiles_grades cascade constraints;
    drop table t_election_profiles_majors cascade constraints;
    drop table t_election_profiles_std_types cascade constraints;
    drop table t_election_profiles_stds cascade constraints;
    drop table t_exam_activities cascade constraints;
    drop table t_exam_activities_exam_rooms cascade constraints;
    drop table t_exam_applies cascade constraints;
    drop table t_exam_apply_switches cascade constraints;
    drop table t_exam_grade_states cascade constraints;
    drop table t_exam_grades cascade constraints;
    drop table t_exam_groups cascade constraints;
    drop table t_exam_groups_lessons cascade constraints;
    drop table t_exam_monitors cascade constraints;
    drop table t_exam_papers cascade constraints;
    drop table t_exam_papers_lessons cascade constraints;
    drop table t_exam_room_capacities cascade constraints;
    drop table t_exam_room_programs cascade constraints;
    drop table t_exam_room_programs_rooms cascade constraints;
    drop table t_exam_rooms cascade constraints;
    drop table t_exam_takes cascade constraints;
    drop table t_exam_turn_schemes cascade constraints;
    drop table t_exam_turns cascade constraints;
    drop table t_exchange_configs cascade constraints;
    drop table t_exchange_course_grades cascade constraints;
    drop table t_exchange_courses cascade constraints;
    drop table t_exchange_grades cascade constraints;
    drop table t_exchange_grades_converts cascade constraints;
    drop table t_exchange_logs cascade constraints;
    drop table t_exchange_projects cascade constraints;
    drop table t_exchange_schools cascade constraints;
    drop table t_exchange_sessions cascade constraints;
    drop table t_exchange_students cascade constraints;
    drop table t_exclusive_subjects cascade constraints;
    drop table t_grade_input_switches cascade constraints;
    drop table t_grade_input_switches_types cascade constraints;
    drop table t_grade_modify_applies cascade constraints;
    drop table t_grade_rate_configs cascade constraints;
    drop table t_grade_rate_items cascade constraints;
    drop table t_grade_view_scopes cascade constraints;
    drop table t_grade_view_scopes_educations cascade constraints;
    drop table t_grade_view_scopes_projects cascade constraints;
    drop table t_grade_view_scopes_std_types cascade constraints;
    drop table t_last_makeup_takes cascade constraints;
    drop table t_last_makeup_tasks cascade constraints;
    drop table t_last_makeup_tasks_classes cascade constraints;
    drop table t_lesson_college_switches cascade constraints;
    drop table t_lesson_for_departs cascade constraints;
    drop table t_lesson_groups cascade constraints;
    drop table t_lesson_materials cascade constraints;
    drop table t_lesson_materials_books cascade constraints;
    drop table t_lesson_plan_relations cascade constraints;
    drop table t_lesson_tags cascade constraints;
    drop table t_lessons cascade constraints;
    drop table t_lessons_exam_types cascade constraints;
    drop table t_lessons_tags cascade constraints;
    drop table t_lessons_teachers cascade constraints;
    drop table t_ma_plans cascade constraints;
    drop table t_major_credit_constraints cascade constraints;
    drop table t_major_plan_comments cascade constraints;
    drop table t_normal_classes cascade constraints;
    drop table t_normal_classes_students cascade constraints;
    drop table t_not_pass_credit_statss cascade constraints;
    drop table t_off_campus_tutors cascade constraints;
    drop table t_other_exam_configs cascade constraints;
    drop table t_other_exam_configs_campuses cascade constraints;
    drop table t_other_exam_loggers cascade constraints;
    drop table t_other_exam_settings cascade constraints;
    drop table t_other_exam_settings_fb_stds cascade constraints;
    drop table t_other_exam_settings_pm_stds cascade constraints;
    drop table t_other_exam_sign_ups cascade constraints;
    drop table t_other_fee_configs cascade constraints;
    drop table t_other_grade_alter_infoes cascade constraints;
    drop table t_other_grades cascade constraints;
    drop table t_program_doc_metas cascade constraints;
    drop table t_program_doc_sections cascade constraints;
    drop table t_program_doc_templates cascade constraints;
    drop table t_program_doc_templates_types cascade constraints;
    drop table t_program_docs cascade constraints;
    drop table t_programs cascade constraints;
    drop table t_retake_fee_configs cascade constraints;
    drop table t_score_sections cascade constraints;
    drop table t_std_apply_logs cascade constraints;
    drop table t_std_course_abilities cascade constraints;
    drop table t_std_credit_constraints cascade constraints;
    drop table t_std_gpas cascade constraints;
    drop table t_std_semester_gpas cascade constraints;
    drop table t_std_year_gpas cascade constraints;
    drop table t_student_programs cascade constraints;
    drop table t_suggest_activities cascade constraints;
    drop table t_suggest_activities_teachers cascade constraints;
    drop table t_teach_qualities cascade constraints;
    drop table t_teacherbook_nums cascade constraints;
    drop table t_textbook_order_configs cascade constraints;
    drop table t_textbook_order_lines cascade constraints;
    drop table t_textbook_prices cascade constraints;
    drop table t_textbooks cascade constraints;
    drop table t_theses cascade constraints;
    drop table t_total_credit_statss cascade constraints;
    drop table tc_external_contacts cascade constraints;
    drop table tc_external_people cascade constraints;
    drop table tc_external_teachers cascade constraints;
    drop table tc_parttime_contacts cascade constraints;
    drop table tc_parttime_people cascade constraints;
    drop table tc_parttime_teachers cascade constraints;
    drop table tc_teacher_contacts cascade constraints;
    drop table xb_book_types cascade constraints;
    drop table xb_classroom_types cascade constraints;
    drop table xb_course_ability_rates cascade constraints;
    drop table xb_course_apply_types cascade constraints;
    drop table xb_course_categories cascade constraints;
    drop table xb_course_hour_types cascade constraints;
    drop table xb_course_types cascade constraints;
    drop table xb_exam_styles cascade constraints;
    drop table xb_fee_types cascade constraints;
    drop table xb_std_label_types cascade constraints;
    drop table xb_std_labels cascade constraints;
    drop table xb_std_types cascade constraints;
    drop sequence seq_D_GOOD_THESISES;
    drop sequence seq_D_THESIS_DOCUMENT_TACHES;
    drop sequence seq_Q_EVA_TEACH_REMESSAGE;
    drop sequence seq_ST_DA_APPLIES;
    drop sequence seq_ST_DA_ITEM_RESULTS;
    drop sequence seq_ST_DA_LOGS;
    drop sequence seq_ST_DA_SEASONS;
    drop sequence seq_ST_DA_STANDARDS;
    drop sequence seq_ST_GA_ITEM_RESULTS;
    drop sequence seq_ST_GA_LOGS;
    drop sequence seq_ST_GA_RESULTS;
    drop sequence seq_ST_GA_SEASONS;
    drop sequence seq_ST_GA_STANDARDS;
    drop sequence seq_ST_PA_COURSE_RESULTS;
    drop sequence seq_ST_PA_GROUP_RESULTS;
    drop sequence seq_ST_PA_LOGS;
    drop sequence seq_ST_PA_RESULTS;
    drop sequence seq_ST_PA_STANDARDS;
    drop sequence seq_T_COURSE_TYPE_CREDIT_CONS;
    drop sequence seq_T_EXAM_APPLY_PARAM;
    drop sequence seq_T_MAJOR_PLAN_CG_MODIFIES;
    drop sequence seq_T_MAJOR_PLAN_CG_MOD_AFTERS;
    drop sequence seq_T_MAJOR_PLAN_CG_MOD_BEFORS;
    drop sequence seq_T_MAJOR_PLAN_C_MODIFIES;
    drop sequence seq_T_MAJOR_PLAN_C_MOD_AFTERS;
    drop sequence seq_T_MAJOR_PLAN_C_MOD_BEFORS;
    drop sequence seq_T_MA_COURSE_SUBS;
    drop sequence seq_T_MA_PLAN_COURSES;
    drop sequence seq_T_MA_PLAN_C_GROUPS;
    drop sequence seq_T_ORI_PLANS;
    drop sequence seq_T_ORI_PLAN_COURSES;
    drop sequence seq_T_ORI_PLAN_C_GROUPS;
    drop sequence seq_T_PER_PLANS;
    drop sequence seq_T_PER_PLAN_COURSES;
    drop sequence seq_T_PER_PLAN_C_GROUPS;
    drop sequence seq_T_SHR_PLANS;
    drop sequence seq_T_SHR_PLAN_COURSES;
    drop sequence seq_T_SHR_PLAN_C_GROUPS;
    drop sequence seq_T_STD_COURSE_COUNT_CONS;
    drop sequence seq_T_STD_COURSE_SUBS;
    drop sequence seq_T_STD_TOTAL_CREDIT_CONS;
    drop sequence seq_XB_EXCHANGE_TYPES;
    drop sequence seq_XB_EXCH_SCHOOL_TYPES;
    drop sequence seq_c_adminclasses;
    drop sequence seq_c_building_course_units;
    drop sequence seq_c_buildings;
    drop sequence seq_c_calendars;
    drop sequence seq_c_campuses;
    drop sequence seq_c_classrooms;
    drop sequence seq_c_default_course_units;
    drop sequence seq_c_departments;
    drop sequence seq_c_direction_journals;
    drop sequence seq_c_directions;
    drop sequence seq_c_habilitations;
    drop sequence seq_c_holidays;
    drop sequence seq_c_major_journals;
    drop sequence seq_c_majors;
    drop sequence seq_c_project_classrooms;
    drop sequence seq_c_project_codes;
    drop sequence seq_c_project_configs;
    drop sequence seq_c_project_properties;
    drop sequence seq_c_projects;
    drop sequence seq_c_schools;
    drop sequence seq_c_semester_stages;
    drop sequence seq_c_semesters;
    drop sequence seq_c_staffs;
    drop sequence seq_c_std_people;
    drop sequence seq_c_student_journals;
    drop sequence seq_c_students;
    drop sequence seq_c_teacher_journals;
    drop sequence seq_c_teachers;
    drop sequence seq_c_time_settings;
    drop sequence seq_cl_apply_time_units;
    drop sequence seq_cl_occupancies;
    drop sequence seq_cl_price_catalogs;
    drop sequence seq_cl_price_configs;
    drop sequence seq_cl_room_applies;
    drop sequence seq_cl_room_usage_capacities;
    drop sequence seq_course_modified_records;
    drop sequence seq_course_modifieds;
    drop sequence seq_d_thesis_active_types;
    drop sequence seq_d_thesis_annotate_actives;
    drop sequence seq_d_thesis_annotate_books;
    drop sequence seq_d_thesis_annotate_filters;
    drop sequence seq_d_thesis_annotate_teachers;
    drop sequence seq_d_thesis_annotates;
    drop sequence seq_d_thesis_answer_actives;
    drop sequence seq_d_thesis_answer_filters;
    drop sequence seq_d_thesis_answers;
    drop sequence seq_d_thesis_coders;
    drop sequence seq_d_thesis_documents;
    drop sequence seq_d_thesis_evaluate_projects;
    drop sequence seq_d_thesis_notices;
    drop sequence seq_d_thesis_pre_answer_actives;
    drop sequence seq_d_thesis_pre_answer_filters;
    drop sequence seq_d_thesis_pre_answers;
    drop sequence seq_d_thesis_processes;
    drop sequence seq_d_thesis_ranks;
    drop sequence seq_d_thesis_sh_annotates;
    drop sequence seq_d_thesis_sh_evaluations;
    drop sequence seq_d_thesis_std_innovates;
    drop sequence seq_d_thesis_teacher_evaluations;
    drop sequence seq_d_thesis_teacher_innovates;
    drop sequence seq_d_thesis_topic_open_actives;
    drop sequence seq_d_thesis_topic_open_filters;
    drop sequence seq_d_thesis_topic_opens;
    drop sequence seq_d_thesis_topic_origins;
    drop sequence seq_d_thesis_types;
    drop sequence seq_d_thesis_undergraduate_actives;
    drop sequence seq_d_thesis_undergraduate_filters;
    drop sequence seq_d_thesis_undergraduates;
    drop sequence seq_f_bill_logs;
    drop sequence seq_f_bills;
    drop sequence seq_f_check_fee_types;
    drop sequence seq_f_pays;
    drop sequence seq_f_tuitions;
    drop sequence seq_gb_countries;
    drop sequence seq_gb_degrees;
    drop sequence seq_gb_divisions;
    drop sequence seq_gb_genders;
    drop sequence seq_gb_languages;
    drop sequence seq_gb_marital_statuses;
    drop sequence seq_gb_nations;
    drop sequence seq_gb_politic_visages;
    drop sequence seq_gb_social_relations;
    drop sequence seq_gb_study_types;
    drop sequence seq_gb_teacher_title_levels;
    drop sequence seq_gb_teacher_titles;
    drop sequence seq_hb_admission_types;
    drop sequence seq_hb_attendance_types;
    drop sequence seq_hb_book_award_types;
    drop sequence seq_hb_course_take_types;
    drop sequence seq_hb_education_modes;
    drop sequence seq_hb_educations;
    drop sequence seq_hb_election_modes;
    drop sequence seq_hb_enroll_modes;
    drop sequence seq_hb_exam_modes;
    drop sequence seq_hb_exam_statuses;
    drop sequence seq_hb_exam_types;
    drop sequence seq_hb_examinee_types;
    drop sequence seq_hb_family_economic_states;
    drop sequence seq_hb_fee_origins;
    drop sequence seq_hb_grade_types;
    drop sequence seq_hb_graduate_states;
    drop sequence seq_hb_hsch_grade_types;
    drop sequence seq_hb_hskdegrees;
    drop sequence seq_hb_idcard_types;
    drop sequence seq_hb_other_exam_categories;
    drop sequence seq_hb_other_exam_subjects;
    drop sequence seq_hb_passport_types;
    drop sequence seq_hb_pay_states;
    drop sequence seq_hb_pay_types;
    drop sequence seq_hb_press_levels;
    drop sequence seq_hb_presses;
    drop sequence seq_hb_production_award_levels;
    drop sequence seq_hb_production_award_types;
    drop sequence seq_hb_production_types;
    drop sequence seq_hb_publication_grades;
    drop sequence seq_hb_publications;
    drop sequence seq_hb_railway_stations;
    drop sequence seq_hb_residences;
    drop sequence seq_hb_room_usages;
    drop sequence seq_hb_score_mark_styles;
    drop sequence seq_hb_std_alter_reasons;
    drop sequence seq_hb_std_alter_types;
    drop sequence seq_hb_std_award_types;
    drop sequence seq_hb_std_punish_types;
    drop sequence seq_hb_std_statuses;
    drop sequence seq_hb_teach_lang_types;
    drop sequence seq_hb_teach_modes;
    drop sequence seq_hb_teacher_states;
    drop sequence seq_hb_teacher_types;
    drop sequence seq_hb_teacher_unit_types;
    drop sequence seq_hb_tutor_types;
    drop sequence seq_hb_uncheckin_reasons;
    drop sequence seq_hb_unregister_reasons;
    drop sequence seq_hb_visa_types;
    drop sequence seq_jb_discipline_catalogs;
    drop sequence seq_jb_discipline_categories;
    drop sequence seq_jb_disciplines;
    drop sequence seq_jb_institutions;
    drop sequence seq_q_college_option_stats;
    drop sequence seq_q_depart_evaluations;
    drop sequence seq_q_department_option_stats;
    drop sequence seq_q_eval_criteria_items;
    drop sequence seq_q_evaluate_results;
    drop sequence seq_q_evaluate_switches;
    drop sequence seq_q_evaluation_criterias;
    drop sequence seq_q_not_evaluate_students;
    drop sequence seq_q_opposite_questions;
    drop sequence seq_q_option_groups;
    drop sequence seq_q_option_stats;
    drop sequence seq_q_options;
    drop sequence seq_q_question_detail_stats;
    drop sequence seq_q_question_results;
    drop sequence seq_q_question_type_stats;
    drop sequence seq_q_question_types;
    drop sequence seq_q_questionnaire_lessons;
    drop sequence seq_q_questionnaire_stats;
    drop sequence seq_q_questionnaires;
    drop sequence seq_q_questions;
    drop sequence seq_q_teacher_option_stats;
    drop sequence seq_q_text_eval_switches;
    drop sequence seq_q_text_evaluations;
    drop sequence seq_s_awards;
    drop sequence seq_s_punishments;
    drop sequence seq_s_std_abroads;
    drop sequence seq_s_std_apply_edit_noteses;
    drop sequence seq_s_std_contacts;
    drop sequence seq_s_std_home_members;
    drop sequence seq_s_std_homes;
    drop sequence seq_s_student_apply_edits;
    drop sequence seq_s_student_equivalents;
    drop sequence seq_s_student_logs;
    drop sequence seq_se_data_fields;
    drop sequence seq_se_data_permissions;
    drop sequence seq_se_data_resources;
    drop sequence seq_se_data_types;
    drop sequence seq_se_func_permissions;
    drop sequence seq_se_func_resources;
    drop sequence seq_se_members;
    drop sequence seq_se_menu_profiles;
    drop sequence seq_se_menus;
    drop sequence seq_se_profile_fields;
    drop sequence seq_se_role_profiles;
    drop sequence seq_se_role_properties;
    drop sequence seq_se_roles;
    drop sequence seq_se_session_profiles;
    drop sequence seq_se_session_stats;
    drop sequence seq_se_user_profiles;
    drop sequence seq_se_user_properties;
    drop sequence seq_se_users;
    drop sequence seq_st_checkins;
    drop sequence seq_st_register_user_groups;
    drop sequence seq_st_registers;
    drop sequence seq_st_report_login_switches;
    drop sequence seq_st_std_admission_majors;
    drop sequence seq_st_std_admissions;
    drop sequence seq_st_std_alteration_items;
    drop sequence seq_st_std_alterations;
    drop sequence seq_st_std_edit_restrictions;
    drop sequence seq_st_std_examinees;
    drop sequence seq_st_std_graduations;
    drop sequence seq_st_std_property_editors;
    drop sequence seq_st_user_student_conditions;
    drop sequence seq_sys_business_log_details;
    drop sequence seq_sys_business_logs;
    drop sequence seq_sys_code_categories;
    drop sequence seq_sys_code_metas;
    drop sequence seq_sys_code_scripts;
    drop sequence seq_sys_entity_metas;
    drop sequence seq_sys_manager_documents;
    drop sequence seq_sys_manager_notices;
    drop sequence seq_sys_message_contents;
    drop sequence seq_sys_notice_contents;
    drop sequence seq_sys_property_config_items;
    drop sequence seq_sys_property_metas;
    drop sequence seq_sys_report_templates;
    drop sequence seq_sys_rule_config_params;
    drop sequence seq_sys_rule_configs;
    drop sequence seq_sys_rule_parameters;
    drop sequence seq_sys_rules;
    drop sequence seq_sys_student_documents;
    drop sequence seq_sys_student_notices;
    drop sequence seq_sys_system_message_configs;
    drop sequence seq_sys_system_messages;
    drop sequence seq_sys_teacher_documents;
    drop sequence seq_sys_teacher_notices;
    drop sequence seq_sys_wkhtmltopdf_paths;
    drop sequence seq_t_arrange_suggests;
    drop sequence seq_t_available_times;
    drop sequence seq_t_book_require_configs;
    drop sequence seq_t_collision_resources;
    drop sequence seq_t_constraint_loggers;
    drop sequence seq_t_course_activities;
    drop sequence seq_t_course_arrange_alters;
    drop sequence seq_t_course_arrange_switches;
    drop sequence seq_t_course_code_standards;
    drop sequence seq_t_course_ext_infoes;
    drop sequence seq_t_course_grade_states;
    drop sequence seq_t_course_grades;
    drop sequence seq_t_course_hours;
    drop sequence seq_t_course_limit_groups;
    drop sequence seq_t_course_limit_items;
    drop sequence seq_t_course_limit_metas;
    drop sequence seq_t_course_mail_settings;
    drop sequence seq_t_course_materials;
    drop sequence seq_t_course_table_checks;
    drop sequence seq_t_course_takes;
    drop sequence seq_t_courses;
    drop sequence seq_t_credit_award_criterias;
    drop sequence seq_t_curriculum_change_applys;
    drop sequence seq_t_elect_loggers;
    drop sequence seq_t_elect_mail_templates;
    drop sequence seq_t_elect_plans;
    drop sequence seq_t_election_profiles;
    drop sequence seq_t_exam_activities;
    drop sequence seq_t_exam_applies;
    drop sequence seq_t_exam_apply_switches;
    drop sequence seq_t_exam_grade_states;
    drop sequence seq_t_exam_grades;
    drop sequence seq_t_exam_groups;
    drop sequence seq_t_exam_monitors;
    drop sequence seq_t_exam_papers;
    drop sequence seq_t_exam_room_capacities;
    drop sequence seq_t_exam_room_programs;
    drop sequence seq_t_exam_rooms;
    drop sequence seq_t_exam_takes;
    drop sequence seq_t_exam_turn_schemes;
    drop sequence seq_t_exam_turns;
    drop sequence seq_t_exchange_configs;
    drop sequence seq_t_exchange_course_grades;
    drop sequence seq_t_exchange_courses;
    drop sequence seq_t_exchange_grades;
    drop sequence seq_t_exchange_logs;
    drop sequence seq_t_exchange_projects;
    drop sequence seq_t_exchange_schools;
    drop sequence seq_t_exchange_sessions;
    drop sequence seq_t_exchange_students;
    drop sequence seq_t_exclusive_subjects;
    drop sequence seq_t_grade_input_switches;
    drop sequence seq_t_grade_modify_applies;
    drop sequence seq_t_grade_rate_configs;
    drop sequence seq_t_grade_rate_items;
    drop sequence seq_t_grade_view_scopes;
    drop sequence seq_t_last_makeup_takes;
    drop sequence seq_t_last_makeup_tasks;
    drop sequence seq_t_lesson_college_switches;
    drop sequence seq_t_lesson_for_departs;
    drop sequence seq_t_lesson_groups;
    drop sequence seq_t_lesson_materials;
    drop sequence seq_t_lesson_plan_relations;
    drop sequence seq_t_lesson_tags;
    drop sequence seq_t_lessons;
    drop sequence seq_t_ma_plans;
    drop sequence seq_t_major_credit_constraints;
    drop sequence seq_t_major_plan_comments;
    drop sequence seq_t_normal_classes;
    drop sequence seq_t_not_pass_credit_statss;
    drop sequence seq_t_off_campus_tutors;
    drop sequence seq_t_other_exam_configs;
    drop sequence seq_t_other_exam_loggers;
    drop sequence seq_t_other_exam_settings;
    drop sequence seq_t_other_exam_sign_ups;
    drop sequence seq_t_other_fee_configs;
    drop sequence seq_t_other_grade_alter_infoes;
    drop sequence seq_t_other_grades;
    drop sequence seq_t_program_doc_metas;
    drop sequence seq_t_program_doc_sections;
    drop sequence seq_t_program_doc_templates;
    drop sequence seq_t_program_docs;
    drop sequence seq_t_programs;
    drop sequence seq_t_retake_fee_configs;
    drop sequence seq_t_score_sections;
    drop sequence seq_t_std_apply_logs;
    drop sequence seq_t_std_course_abilities;
    drop sequence seq_t_std_credit_constraints;
    drop sequence seq_t_std_gpas;
    drop sequence seq_t_std_semester_gpas;
    drop sequence seq_t_std_year_gpas;
    drop sequence seq_t_student_programs;
    drop sequence seq_t_suggest_activities;
    drop sequence seq_t_teach_qualities;
    drop sequence seq_t_teacherbook_nums;
    drop sequence seq_t_textbook_order_configs;
    drop sequence seq_t_textbook_order_lines;
    drop sequence seq_t_textbook_prices;
    drop sequence seq_t_textbooks;
    drop sequence seq_t_theses;
    drop sequence seq_t_total_credit_statss;
    drop sequence seq_tc_external_contacts;
    drop sequence seq_tc_external_people;
    drop sequence seq_tc_external_teachers;
    drop sequence seq_tc_parttime_contacts;
    drop sequence seq_tc_parttime_people;
    drop sequence seq_tc_parttime_teachers;
    drop sequence seq_tc_teacher_contacts;
    drop sequence seq_xb_book_types;
    drop sequence seq_xb_classroom_types;
    drop sequence seq_xb_course_ability_rates;
    drop sequence seq_xb_course_apply_types;
    drop sequence seq_xb_course_categories;
    drop sequence seq_xb_course_hour_types;
    drop sequence seq_xb_course_types;
    drop sequence seq_xb_exam_styles;
    drop sequence seq_xb_fee_types;
    drop sequence seq_xb_std_label_types;
    drop sequence seq_xb_std_labels;
    drop sequence seq_xb_std_types
    ...
    create table D_THESIS_DOCUMENT_TACHES (
        id number(19,0) not null,
        active_id number(19,0),
        active_type_id raw(255),
    ...
    create table D_THESIS_NOTICE_DEPARTS (
        NOTICE_ID number(19,0) not null,
        DEPART_ID number(10,0) not null,
    ...
    create table Q_EVA_TEACH_REMESSAGE (
        ...
        text_evaluation_id number(19,0),
        primary key (id)
    );

    create table Q_EVA_TEA_REM_STDS (
        q_eva_teach_remessage_id number(19,0) not null,
        student_id number(19,0) not null,
    ...
    create table ST_DA_SEASONS_DEPARTMENTS (
        SEASON_ID number(19,0) not null,
    ...
    create table ST_DA_STANDARDS_DEPARTMENTS (
        STANDARD_ID number(19,0) not null,
        DEPARTMENT_ID number(10,0) not null,
    ...
    create table ST_DA_STANDARDS_RULE_CFGS (
        STANDARD_ID number(19,0) not null,
        RULE_CONFIG_ID number(10,0) not null,
    ...
    create table ST_PA_COURSE_RESULTS (
        id number(19,0) not null,
        compulsory number(1,0) not null,
        passed number(1,0) not null,
        remark varchar2(255 char),
        scores varchar2(255 char),
        course_id number(19,0),
        group_result_id number(19,0),
        primary key (id)
    );
    ...
    create table ST_PA_GROUP_RESULTS (
        ...
        num_completed number(10,0) not null,
        num_required number(10,0) not null,
        name varchar2(255 char),
        passed number(1,0) not null,
        relation varchar2(255 char),
        course_type_id number(10,0),
        parent_id number(19,0),
        plan_result_id number(19,0),
        primary key (id)
    );
    ...
    create table ST_PA_RESULTS (
        ...
        depart_opinion varchar2(255 char),
        final_opinion varchar2(255 char),
        gpa float,
        partial number(1,0) not null,
        passed number(1,0) not null,
        published number(1,0) not null,
        remark varchar2(255 char),
        updates varchar2(255 char),
        std_id number(19,0),
        primary key (id)
    );
    ...
    create table ST_PA_STANDARDS (
        ...
        remark varchar2(255 char),
        grades varchar2(255 char),
        convert_target_course_type_id number(10,0),
        project_id number(10,0),
        primary key (id)
    );
    ...
    create table ST_PA_STANDARDS_CONVERTABLES (
        STANDARD_ID number(19,0) not null,
        CONVERTABLE_TYPE_ID number(10,0) not null,
    ...
    create table ST_PA_STANDARDS_DISAUDITS (
        STANDARD_ID number(19,0) not null,
        DISAUDIT_TYPE_ID number(10,0) not null,
    ...
    create table T_ELECT_PROFIES_ELECT_CFGS (
        election_profile_id number(19,0) not null,
        rule_config_id number(10,0) not null,
    ...
    create table T_ELECT_PROFIES_ELECT_LESSONS (
        election_profile_id number(19,0) not null,
        LESSON_ID number(19,0) not null,
    ...
    create table T_LESSON_FOR_D_L_IDS (
        lesson_for_depart_id number(19,0) not null,
        LESSON_ID number(19,0)
    );
    ...
    create table T_MAJOR_PLAN_CG_MODIFIES (
        ...
        assessor_id number(19,0),
        department_id number(10,0),
        new_plan_course_group_id number(19,0),
        old_plan_course_group_id number(19,0),
        proposer_id number(19,0),
        primary key (id)
    );

    create table T_MAJOR_PLAN_CG_MOD_AFTERS (
        id number(19,0) not null,
        course_num number(10,0) not null,
        ...
        course_type_id number(10,0),
        fake_course_type_id number(10,0),
        primary key (id)
    );
    ...
    create table T_MAJOR_PLAN_C_MODIFIES (
        ...
        assessor_id number(19,0),
        department_id number(10,0),
        new_plan_course_id number(19,0),
        old_plan_course_id number(19,0),
        proposer_id number(19,0),
        primary key (id)
    );
    ...
    create table T_MAJOR_PLAN_C_MOD_AFT_C_H (
        MAJOR_PLAN_C_MOD_AFT_ID number(19,0) not null,
        COURSE_HOUR number(10,0),
        COURSE_HOUR_TYPE_ID number(10,0) not null,
    ...
    create table T_MAJOR_PLAN_C_MOD_BEF_C_H (
        MAJOR_PLAN_C_MOD_BEF_ID number(19,0) not null,
        COURSE_HOUR number(10,0),
        COURSE_HOUR_TYPE_ID number(10,0) not null,
    ...
    create table T_MA_COURSE_SUBS (
        ...
        education_id number(10,0),
        major_id number(10,0),
        project_id number(10,0),
        std_type_id number(10,0),
        primary key (id)
    );

    create table T_MA_COURSE_SUBS_ORIGS (
        t_ma_course_subs_id number(19,0) not null,
    ...
    create table T_MA_PLAN_C_GROUPS (
        ...
        micro_name varchar2(255 char),
        course_type_id number(10,0),
        direction_id number(10,0),
        parent_id number(19,0),
        plan_id number(19,0) not null,
        share_course_group_id number(19,0),
        OrderInGroup number(10,0),
        OrderInPlan number(10,0),
        primary key (id)
    );

    create table T_MA_PLAN_C_GROUPS_REQ_CORS (
        t_ma_plan_c_groups_id number(19,0) not null,
        course_id number(19,0) not null,
    ...
    create table T_ORI_PLANS (
        id number(19,0) not null,
        credits float not null,
        terms_count number(10,0),
        end_term number(10,0),
        start_term number(10,0),
    ...
    create table T_ORI_PLAN_C_GROUPS_REQ_CORS (
        t_ori_plan_c_groups_id number(19,0) not null,
        course_id number(19,0) not null,
    ...
    create table T_PER_PLAN_C_GROUPS_REQ_CORS (
        t_per_plan_c_groups_id number(19,0) not null,
        course_id number(19,0) not null,
    ...
    create table T_STD_COURSE_SUBS_ORIGS (
        t_std_course_subs_id number(19,0) not null,
        course_id number(19,0) not null,
    ...
    create table c_adminclasses (
        ...
        invalid_at timestamp,
        name varchar2(255 char),
        plan_count number(10,0) not null,
        remark varchar2(255 char),
        std_count number(10,0) not null,
        project_id number(10,0),
        education_id number(10,0),
        department_id number(10,0),
        direction_id number(10,0),
    ...
    create table c_adminclasses_instructors (
        adminclass_id number(10,0) not null,
    ...
    create table c_building_course_units (
        id number(10,0) not null,
        end_time number(10,0) not null,
        start_time number(10,0) not null,
        building_id number(10,0),
        time_setting_id number(10,0),
        unit_id number(10,0),
        primary key (id)
    );
    ...
    create table c_classrooms_departments (
        classroom_id number(10,0) not null,
        department_id number(10,0) not null,
    ...
    create table c_departments (
        ...
        name varchar2(255 char),
        remark varchar2(255 char),
        college number(1,0) not null,
        indexno varchar2(255 char),
        teaching number(1,0) not null,
        school_id number(19,0),
    ...
    create table c_major_journals (
        id number(10,0) not null,
        code varchar2(255 char),
        discipline_code varchar2(255 char),
        duration float,
        effective_at timestamp,
        eng_name varchar2(255 char),
        invalid_at timestamp,
    ...
    create table c_project_classrooms_departs (
        project_classroom_id number(10,0) not null,
        department_id number(10,0) not null,
    ...
    create table c_project_classrooms_reserved (
        ...
        week_state_num number(19,0) not null,
    ...
    create table c_projects_labels (
        project_id number(10,0) not null,
        std_label_id number(10,0) not null
    );

    create table c_projects_time_settings (
        project_id number(10,0) not null,
        time_setting_id number(10,0) not null
    );
    ...
    create table c_semester_stages (
        id number(10,0) not null,
        end_week number(10,0) not null,
        name varchar2(255 char),
        remark varchar2(255 char),
        start_week number(10,0) not null,
        semester_id number(10,0),
        primary key (id)
    );
    ...
    create table c_semesters (
        id number(10,0) not null,
        archived number(1,0) not null,
        begin_on date,
        code varchar2(255 char),
        end_on date,
        first_weekday number(10,0) not null,
        name varchar2(255 char),
        remark varchar2(255 char),
        school_year varchar2(255 char),
        calendar_id number(10,0),
        primary key (id)
    );
    ...
    create table c_staffs (
        ...
        idcard_type_id number(10,0),
        nation_id number(10,0),
        politic_visage_id number(10,0),
        primary key (id)
    );
    ...
    create table c_std_people (
        ...
        ancestral_addr_id number(10,0),
        country_id number(10,0),
        gender_id number(10,0),
        idcard_type_id number(10,0),
        marital_status_id number(10,0),
        nation_id number(10,0),
        politic_visage_id number(10,0),
        primary key (id)
    );
    ...
    create table c_student_journals (
        ...
        end_on date,
        grade varchar2(255 char),
        inschool number(1,0) not null,
        remark varchar2(255 char),
        adminclass_id number(10,0),
        department_id number(10,0),
        direction_id number(10,0),
        major_id number(10,0),
    ...
    create table c_students (
        ...
        gender_id number(10,0),
        major_id number(10,0),
        major_depart_id number(10,0),
        person_id number(19,0),
        study_type_id number(10,0),
        tutor_id number(19,0),
        type_id number(10,0),
        primary key (id)
    );
    ...
    create table c_teachers (
        ...
        department_id number(10,0),
        education_id number(10,0),
        parttime_depart_id number(10,0),
        staff_id number(19,0),
        state_id number(10,0),
        teacher_type_id number(10,0),
        title_id number(10,0),
        tutor_type_id number(10,0),
        unit_type_id number(10,0),
        primary key (id)
    );
    ...
    create table cl_apply_time_units (
        id number(19,0) not null,
        end_unit number(10,0) not null,
        start_unit number(10,0) not null,
        end_time number(10,0) not null,
        start_time number(10,0) not null,
        week_state varchar2(255 char),
        week_state_num number(19,0) not null,
    ...
    create table cl_price_catalogs_audit_departs (
        price_catalog_id number(19,0) not null,
        department_id number(10,0) not null,
    ...
    create table cl_price_catalogs_prices (
        price_catalog_id number(19,0) not null,
        price_config_id number(19,0) not null,
        primary key (price_catalog_id, price_config_id)
    );

    create table cl_price_configs (
        id number(19,0) not null,
        max_seats number(10,0) not null,
        min_seats number(10,0) not null,
        price float not null,
        catalog_id number(19,0),
        room_config_type_id number(10,0),
        primary key (id)
    );
    ...
    create table cl_room_applies (
        ...
        created_at timestamp,
        updated_at timestamp,
        attendance number(10,0) not null,
        ...
        is_depart_approved number(1,0),
        is_free number(1,0),
        is_multimedia number(1,0),
        money float,
        room_request varchar2(255 char),
        time_request varchar2(255 char),
        unit_attendance number(10,0) not null,
        water_fee float,
        project_id number(10,0),
        approve_by_id number(19,0),
        audit_depart_id number(10,0),
        campus_id number(10,0),
        depart_approve_by_id number(19,0),
        semester_id number(10,0),
        usage_id number(10,0),
        user_id number(19,0),
        primary key (id)
    ...
    create table cl_room_applies_classrooms (
        room_apply_id number(19,0) not null,
        classroom_id number(10,0) not null
    );

    create table cl_room_applies_occupations (
        room_apply_id number(19,0) not null,
        occupancy_id number(19,0) not null,
    ...
    create table cl_room_usage_capacities (
        id number(19,0) not null,
        capacity number(10,0) not null,
        max_capacity number(10,0) not null,
        room_id number(10,0),
        usage_id number(10,0),
        primary key (id)
    );
    ...
    create table course_modified_records (
        ...
        reply_at timestamp,
        status number(1,0),
        apply_user_id number(19,0),
        course_id number(19,0),
        new_modified_id number(19,0),
        reply_user_id number(19,0),
        primary key (id)
    );
    ...
    create table d_thesis_annotate_actives (
        ...
        end_date timestamp,
        effected number(1,0),
        tutor_audited number(1,0),
        remark varchar2(800 char),
        allow_apply_count number(10,0),
        process number(19,0),
        number_year number(10,0),
        start_number number(10,0),
        expert_suffix varchar2(30 char),
        effect_count number(10,0),
    ...
    create table d_thesis_annotates (
        ...
        std number(19,0),
        title varchar2(255 char),
        apply_count number(10,0),
        tutor_audited number(10,0),
        passed number(1,0),
        overed number(1,0),
        active raw(255),
        file_name varchar2(255 char),
        department_validate number(1,0),
        tutor_validate number(1,0),
        is_double_blind number(1,0),
        avg_mark float,
    ...
    create table d_thesis_notices_documents (
        thesis_notice_bean_id number(19,0) not null,
        thesis_document_id number(19,0) not null,
        primary key (thesis_notice_bean_id, thesis_document_id)
    );

    create table d_thesis_pre_answer_actives (
        ID raw(255) not null,
        name varchar2(255 char),
        active_type raw(255),
        start_date timestamp,
    ...
    create table d_thesis_pre_answer_filters (
        ID raw(255) not null,
        property_name varchar2(10 char),
        content varchar2(80 char),
        operate varchar2(10 char),
    ...
    create table d_thesis_teacher_evaluations (
        ID raw(255) not null,
        content varchar2(1 char),
        evaluate_project raw(255),
        book raw(255),
    ...
    create table d_thesis_topic_open_actives (
        ID raw(255) not null,
        name varchar2(255 char),
        active_type raw(255),
        start_date timestamp,
    ...
    create table d_thesis_topic_open_filters (
        ID raw(255) not null,
        property_name varchar2(10 char),
        content varchar2(80 char),
        operate varchar2(10 char),
    ...
    create table d_thesis_topic_opens (
        ...
        words_count float,
        finish_date timestamp,
        save_or_sub number(10,0),
        sub_final number(1,0),
        final_tutor_audited number(10,0),
    ...
    create table d_thesis_undergraduate_actives (
        ID raw(255) not null,
        name varchar2(255 char),
        active_type raw(255),
        start_date timestamp,
    ...
    create table d_thesis_undergraduate_filters (
        ID raw(255) not null,
        property_name varchar2(10 char),
        content varchar2(80 char),
        operate varchar2(10 char),
    ...
    create table hb_course_take_types (
        ...
        name varchar2(255 char),
        updated_at timestamp,
        exam number(1,0) not null,
        retake number(1,0) not null,
        primary key (id)
    );
    ...
    create table q_evaluate_results (
        ...
        remark varchar2(255 char),
        stat_state number(1,0),
        stat_type number(10,0),
        department_id number(10,0),
        lesson_id number(19,0),
        questionnaire_id number(19,0),
    ...
    create table q_opposite_questions (
        id number(19,0) not null,
        oppo_question_id number(19,0),
        orgin_question_id number(19,0),
        primary key (id)
    );
    ...
    create table q_question_detail_stats (
        ...
        sum_count number(10,0) not null,
        total double precision,
        question_id number(19,0),
        evaluate_teacher_stat_id number(19,0),
        evaluate_department_stat_id number(19,0),
        evaluate_college_stat_id number(19,0),
        primary key (id)
    );
    ...
    create table q_question_type_stats (
        id number(19,0) not null,
        score float,
        questionnaire_stat_id number(19,0),
        type_id number(19,0),
        primary key (id)
    );
    ...
    create table q_questionnaire_lessons (
        id number(19,0) not null,
        evaluate_by_teacher number(1,0) not null,
        lesson_id number(19,0),
        questionnaire_id number(19,0),
        primary key (id)
    );
    ...
    create table q_questionnaire_stats (
        DTYPE varchar2(31 char) not null,
        id number(19,0) not null,
        add_score double precision,
        all_tickets number(10,0),
        depart_rank number(10,0),
    ...
    create table q_questionnaire_stats_details (
        questionnaire_stat_id number(19,0) not null,
        question_detail_stat_id number(19,0) not null,
        primary key (questionnaire_stat_id, question_detail_stat_id)
    );

    create table q_questionnaire_stats_scores (
        questionnaire_stat_id number(19,0) not null,
        question_type_stat_id number(19,0) not null,
    ...
    create table q_questionnaires_oppo_qs (
        questionnaire_id number(19,0) not null,
        opposite_question_id number(19,0) not null,
    ...
    create table q_text_eval_switches (
        ...
        opened_teacher number(1,0) not null,
        text_evaluate_opened number(1,0) not null,
        primary key (id)
    );
    ...
    create table q_text_evaluations (
        ...
        is_affirm number(1,0),
        is_for_course number(1,0),
        lesson_id number(19,0),
        semester_id number(10,0),
        std_id number(19,0),
        teacher_id number(19,0),
    ...
    create table s_std_abroads (
        ...
        person_id number(19,0),
        hskdegree_id number(10,0),
        passport_type_id number(10,0),
        visa_type_id number(10,0),
        primary key (id)
    );
    ...
    create table s_std_homes (
        ...
        postcode varchar2(255 char),
        person_id number(19,0),
        economic_state_id number(10,0),
        railway_station_id number(10,0),
        primary key (id)
    );
    ...
    create table se_data_permissions (
        ...
        attrs varchar2(255 char),
        effective_at timestamp,
        filters varchar2(255 char),
        invalid_at timestamp,
        remark varchar2(255 char),
        restrictions varchar2(255 char),
        func_resource_id number(10,0),
        resource_id number(10,0),
        role_id number(10,0),
        primary key (id)
    );
    ...
    create table se_members (
        ...
        created_at timestamp,
        updated_at timestamp,
        granter number(1,0) not null,
        manager number(1,0) not null,
        member number(1,0) not null,
        role_id number(10,0),
        user_id number(19,0),
        primary key (id)
    );
    ...
    create table se_session_profiles (
        id number(10,0) not null,
        capacity number(10,0) not null,
        inactive_interval number(5,0) not null,
        user_max_sessions number(5,0) not null,
        role_id number(10,0),
        primary key (id)
    );
    ...
    create table se_sessioninfo_logs (
        ...
        agent varchar2(255 char),
        fullname varchar2(255 char),
        ip varchar2(255 char),
        login_at timestamp,
        logout_at timestamp,
        online_time number(19,0),
    ...
    create table st_checkins (
        ...
        checkin_by varchar2(255 char),
        checkin_from varchar2(255 char),
        whereabouts varchar2(255 char),
    ...
    create table st_register_user_groups_users (
        register_user_group_id number(19,0) not null,
    ...
    create table st_registers (
        id number(19,0) not null,
        checkin number(1,0) not null,
        registed number(1,0) not null,
        register_at timestamp,
        register_by varchar2(255 char),
        register_from varchar2(255 char),
        remark varchar2(255 char),
        tuition_paid number(1,0) not null,
        reason_id number(10,0),
        semester_id number(10,0),
        std_id number(19,0),
        primary key (id)
    ...
    create table st_std_admission_majors (
        ...
        major_code varchar2(255 char),
        major_name varchar2(255 char),
        recommend_by varchar2(255 char),
        std_id number(19,0),
        degree_id number(10,0),
        discipline_category_id number(10,0),
        primary key (id)
    );
    ...
    create table st_std_admissions (
        ...
        created_at timestamp,
        updated_at timestamp,
        admission_index varchar2(255 char),
        letter_no varchar2(255 char),
        std_id number(19,0),
        admission_type_id number(10,0),
        department_id number(10,0),
        fee_origin_id number(10,0),
        major_id number(10,0),
        primary key (id)
    );
    ...
    create table st_std_edit_restrictions_metas (
        std_edit_restriction_id number(19,0) not null,
        property_meta_id number(10,0) not null,
    ...
    create table st_std_examinees (
        ...
        std_id number(19,0),
        education_id number(10,0),
        education_mode_id number(10,0),
        enroll_mode_id number(10,0),
        examinee_type_id number(10,0),
        language_id number(10,0),
        origin_division_id number(10,0),
        primary key (id)
    );

    create table st_std_examinees_scores (
        std_examinee_id number(19,0) not null,
        score float,
        type_id number(10,0) not null,
    ...
    create table sys_code_scripts (
        ...
        created_at timestamp,
        updated_at timestamp,
        attr varchar2(255 char),
        code_class_name varchar2(255 char),
        code_name varchar2(255 char),
        description varchar2(255 char),
        script varchar2(255 char),
        primary key (id)
    );
    ...
    create table sys_student_documents_departs (
        student_document_id number(19,0) not null,
        department_id number(10,0) not null,
        primary key (student_document_id, department_id)
    );

    create table sys_student_documents_std_types (
        student_document_id number(19,0) not null,
        std_type_id number(10,0) not null,
    ...
    create table sys_student_notices_departs (
        student_notice_id number(19,0) not null,
        department_id number(10,0) not null,
    ...
    create table t_arrange_suggests_rooms (
        arrange_suggest_id number(19,0) not null,
        classroom_id number(10,0) not null,
    ...
    create table t_available_times (
        id number(19,0) not null,
        available varchar2(255 char),
        remark varchar2(255 char),
        struct varchar2(255 char),
        units number(10,0) not null,
        primary key (id)
    );
    ...
    create table t_constraint_loggers (
        id number(19,0) not null,
        constraint_type varchar2(255 char),
        created_at timestamp,
    ...
    create table t_course_activities (
        ...
        end_unit number(10,0),
        start_time number(10,0),
        start_unit number(10,0),
        week_state varchar2(255 char),
        week_state_num number(19,0),
        weekday number(10,0),
        lesson_id number(19,0),
        primary key (id)
    );
    ...
    create table t_course_activities_rooms (
        course_activity_id number(19,0) not null,
        classroom_id number(10,0) not null,
    ...
    create table t_course_arrange_alters (
        id number(19,0) not null,
        alter_from varchar2(255 char),
        alteration_after varchar2(255 char),
        alteration_at timestamp,
        alteration_before varchar2(255 char),
        lesson_id number(19,0),
        alter_by_id number(19,0),
        semester_id number(10,0),
        primary key (id)
    );
    ...
    create table t_course_code_standards (
        ...
        seq_length number(10,0) not null,
        project_id number(10,0),
        primary key (id)
    );
    ...
    create table t_course_ext_infoes (
        ...
        compulsory number(1,0) not null,
        description varchar2(255 char),
        eng_description varchar2(255 char),
    ...
    create table t_course_ext_infoes_teachers (
        course_ext_info_id number(19,0) not null,
        teacher_id number(19,0) not null
    );
    ...
    create table t_course_grade_states (
        ...
        operator varchar2(255 char),
        precision number(10,0) not null,
        status number(10,0) not null,
        audit_reason varchar2(255 char),
        audit_status varchar2(255 char),
        ratioa float,
        ratiob float,
        score_mark_style_id number(10,0),
        extra_inputer_id number(19,0),
        lesson_id number(19,0),
        primary key (id)
    );
    ...
    create table t_course_grades (
        ...
        remark varchar2(255 char),
        mark_style_id number(10,0),
        project_id number(10,0),
        semester_id number(10,0),
        std_id number(19,0),
        course_id number(19,0),
        course_take_type_id number(10,0),
        course_type_id number(10,0),
        exam_mode_id number(10,0),
        lesson_id number(19,0),
        primary key (id)
    ...
    create table t_course_grades_exchanges (
        course_grade_id number(19,0) not null,
        exchange_course_id number(19,0) not null,
    ...
    create table t_course_limit_groups (
        id number(19,0) not null,
        cur_count number(10,0) not null,
        for_class number(1,0) not null,
        max_count number(10,0) not null,
        name varchar2(255 char),
        lesson_id number(19,0),
        primary key (id)
    );
    ...
    create table t_course_materials (
        ...
        passed number(1,0),
        reference_books varchar2(255 char),
        remark varchar2(255 char),
        status varchar2(255 char),
        use_explain varchar2(255 char),
        course_id number(19,0),
        department_id number(10,0),
        semester_id number(10,0),
        primary key (id)
    ...
    create table t_course_materials_books (
        course_material_id number(19,0) not null,
        textbook_id number(19,0) not null
    );

    create table t_course_table_checks (
        id number(19,0) not null,
        confirm number(1,0) not null,
    ...
    create table t_course_takes (
        ...
        updated_at timestamp,
        attend number(1,0) not null,
        paid number(1,0) not null,
        remark varchar2(255 char),
        turn number(10,0),
        bill_id number(19,0),
        course_take_type_id number(10,0),
        election_mode_id number(10,0),
        lesson_id number(19,0),
        limit_group_id number(19,0),
        std_id number(19,0),
        primary key (id)
    );
    ...
    create table t_courses (
        ...
        exchange number(1,0) not null,
        name varchar2(255 char),
        period number(10,0) not null,
        remark varchar2(255 char),
        week_hour number(10,0) not null,
        weeks number(10,0),
        project_id number(10,0),
        category_id number(10,0),
        course_type_id number(10,0),
    ...
    create table t_courses_ability_rates (
        course_id number(19,0) not null,
        course_ability_rate_id number(10,0) not null,
    ...
    create table t_courses_prerequisites (
        course_id number(19,0) not null,
        precourse_id number(19,0) not null,
    ...
    create table t_elect_loggers (
        ...
        std_code varchar2(255 char),
        std_name varchar2(255 char),
        turn number(10,0),
        type number(10,0),
        course_take_type_id number(10,0),
        election_mode_id number(10,0),
    ...
    create table t_elect_plans_rule_configs (
        elect_plan_id number(19,0) not null,
        rule_config_id number(10,0) not null,
    ...
    create table t_election_profiles (
        ...
        name varchar2(255 char),
        notice varchar2(255 char),
        open_election number(1,0) not null,
        open_withdraw number(1,0) not null,
        profile_type varchar2(255 char),
        turn number(10,0) not null,
    ...
    create table t_exam_activities_exam_rooms (
        exam_activity_id number(19,0) not null,
        exam_room_id number(19,0) not null,
    ...
    create table t_exam_applies (
        id number(19,0) not null,
        apply_at timestamp,
        exam_apply_type varchar2(255 char),
        passed number(1,0),
        remark varchar2(255 char),
        exam_take_id number(19,0),
        primary key (id)
    );
    ...
    create table t_exam_grade_states (
        ...
        remark varchar2(255 char),
        score_mark_style_id number(10,0),
        grade_state_id number(19,0),
        grade_type_id number(10,0),
        primary key (id)
    );
    ...
    create table t_exam_groups (
        ...
        exam_type_id number(10,0),
        project_id number(10,0),
        room_program_id number(19,0),
        scheme_id number(19,0),
        semester_id number(10,0),
        primary key (id)
    );

    create table t_exam_groups_lessons (
        exam_group_id number(19,0) not null,
        lesson_id number(19,0) not null,
    ...
    create table t_exam_papers_lessons (
        exam_paper_id number(19,0) not null,
        lesson_id number(19,0) not null
    );
    ...
    create table t_exam_room_programs_rooms (
        exam_room_program_id number(19,0) not null,
        classroom_id number(10,0) not null,
    ...
    create table t_exam_rooms (
        id number(19,0) not null,
        end_at timestamp,
        room_apply_id number(19,0),
        start_at timestamp,
        department_id number(10,0),
        examiner_id number(19,0),
        room_id number(10,0),
        semester_id number(10,0),
        primary key (id)
    );
    ...
    create table t_exam_turns (
        id number(19,0) not null,
        begin_time number(10,0),
        end_time number(10,0),
        eng_name varchar2(255 char),
        name varchar2(255 char),
        seq_no number(10,0) not null,
        examTurnScheme_id number(19,0),
        primary key (id)
    );
    ...
    create table t_exchange_grades_converts (
        exchange_grade_id number(19,0) not null,
        exchange_course_grade_id number(19,0) not null,
    ...
    create table t_exchange_students (
        ...
        created_at timestamp,
        updated_at timestamp,
        admin_audit varchar2(255 char),
        depart_audit varchar2(255 char),
        effective_at timestamp,
        invalid_at timestamp,
        state number(10,0),
        session_id number(19,0),
    ...
    create table t_exclusive_subjects (
        id number(19,0) not null,
        config_id number(19,0),
        subject_one_id number(10,0),
        subject_two_id number(10,0),
        primary key (id)
    );
    ...
    create table t_grade_input_switches (
        id number(19,0) not null,
        end_at timestamp,
        need_validate number(1,0) not null,
        opened number(1,0) not null,
        remark varchar2(255 char),
        start_at timestamp,
        project_id number(10,0),
    ...
    create table t_grade_input_switches_types (
        grade_input_switch_id number(19,0) not null,
        grade_type_id number(10,0) not null,
    ...
    create table t_grade_modify_applies (
        ...
        applyer varchar2(255 char),
        audit_reason varchar2(255 char),
        auditer varchar2(255 char),
        final_auditer varchar2(255 char),
        orig_score float,
        ...
        course_id number(19,0),
        exam_status_id number(10,0),
        exam_status_before_id number(10,0),
        grade_type_id number(10,0),
        project_id number(10,0),
        semester_id number(10,0),
        std_id number(19,0),
    ...
    create table t_grade_view_scopes (
        id number(19,0) not null,
        check_evaluation number(1,0) not null,
        enroll_years varchar2(255 char),
        primary key (id)
    );

    create table t_grade_view_scopes_educations (
        grade_view_scope_id number(19,0) not null,
        education_id number(10,0) not null,
    ...
    create table t_last_makeup_tasks (
        ...
        input_at timestamp,
        published number(1,0) not null,
        seq_no varchar2(255 char),
        std_count number(10,0) not null,
        submit_grade number(1,0) not null,
        project_id number(10,0),
        course_id number(19,0),
        depart_id number(10,0),
        semester_id number(10,0),
    ...
    create table t_last_makeup_tasks_classes (
        last_makeup_task_id number(19,0) not null,
        adminclass_id number(10,0) not null,
    ...
    create table t_lesson_groups (
        ...
        created_at timestamp,
        updated_at timestamp,
        lesson_size number(10,0) not null,
        name varchar2(255 char),
        project_id number(10,0),
        semester_id number(10,0),
        teach_depart_id number(10,0),
        primary key (id)
    );
    ...
    create table t_lesson_materials_books (
        lesson_material_id number(19,0) not null,
        textbook_id number(19,0) not null
    );
    ...
    create table t_lessons (
        ...
        remark varchar2(255 char),
        grade varchar2(255 char),
        limit_count number(10,0) not null,
        limit_locked number(1,0) not null,
        name varchar2(255 char),
        reserved_count number(10,0) not null,
        std_count number(10,0) not null,
        project_id number(10,0),
        campus_id number(10,0),
        course_id number(19,0),
        room_type_id number(10,0),
        course_type_id number(10,0),
        exam_mode_id number(10,0),
        group_id number(19,0),
        lang_type_id number(10,0),
        semester_id number(10,0),
        depart_id number(10,0),
        teach_depart_id number(10,0),
        primary key (id)
    ...
    create table t_lessons_exam_types (
        lesson_id number(19,0) not null,
        exam_type_id number(10,0) not null,
        primary key (lesson_id, exam_type_id)
    );

    create table t_lessons_tags (
        lesson_id number(19,0) not null,
        lesson_tag_id number(19,0) not null
    );
    ...
    create table t_normal_classes_students (
        normal_class_id number(19,0) not null,
        student_id number(19,0) not null,
    ...
    create table t_other_exam_configs_campuses (
        t_other_exam_configs_id number(19,0) not null,
        campus_id number(10,0) not null,
    ...
    create table t_other_exam_settings (
        ...
        begin_at timestamp,
        end_at timestamp,
        fee_of_material double precision,
        fee_of_outline double precision,
        fee_of_sign_up double precision,
        field_visable number(1,0),
        grade varchar2(255 char),
        grade_permited number(1,0) not null,
        have_paid number(1,0) not null,
        max_std number(10,0),
        re_exam_allowed number(1,0) not null,
        config_id number(19,0),
        subject_id number(10,0),
        super_subject_id number(10,0),
        primary key (id)
    );

    create table t_other_exam_settings_fb_stds (
        t_other_exam_settings_id number(19,0) not null,
        student_id number(19,0) not null,
    ...
    create table t_other_exam_sign_ups (
        id number(19,0) not null,
        exam_no varchar2(255 char),
        fee_of_material double precision,
        fee_of_outline double precision,
        fee_of_sign_up double precision,
        sign_up_at timestamp,
        take_bus number(1,0) not null,
        bill_id number(19,0),
        campus_id number(10,0),
        pay_state_id number(10,0),
        semester_id number(10,0),
        std_id number(19,0),
        subject_id number(10,0),
        primary key (id)
    ...
    create table t_other_fee_configs (
        ...
        close_at timestamp,
        dead_line timestamp,
        fee_rule_script varchar2(255 char),
        fee_rule_state varchar2(255 char),
        open_at timestamp,
        opened number(1,0) not null,
        pay_duration number(19,0),
        fee_type_id number(10,0),
        project_id number(10,0),
        semester_id number(10,0),
        primary key (id)
    ...
    create table t_program_doc_templates_types (
        program_doc_template_id number(19,0) not null,
        std_type_id number(10,0) not null,
    ...
    create table t_retake_fee_configs (
        ...
        opened number(1,0) not null,
        pay_duration number(19,0),
        price_per_credit number(10,0) not null,
        fee_type_id number(10,0),
        project_id number(10,0),
        semester_id number(10,0),
        primary key (id)
    ...
    create table t_std_apply_logs (
        id number(19,0) not null,
        apply_on timestamp,
        apply_type number(10,0),
        course_code varchar2(255 char),
        course_credit float,
        course_name varchar2(255 char),
        ip varchar2(255 char),
        remark varchar2(255 char),
        result_type number(10,0) not null,
        semester_id number(10,0),
        std_code varchar2(255 char),
        std_id number(19,0),
        std_name varchar2(255 char),
    ...
    create table t_suggest_activities (
        ...
        week_state_num number(19,0),
        weekday number(10,0),
        arrange_suggest_id number(19,0),
        primary key (id)
    );

    create table t_suggest_activities_teachers (
        suggest_activity_id number(19,0) not null,
        teacher_id number(19,0) not null,
    ...
    create table t_teach_qualities (
        id number(19,0) not null,
        state number(10,0),
        std_learn varchar2(255 char),
        teach varchar2(255 char),
        teach_experience varchar2(255 char),
    ...
    create table t_textbook_order_configs (
        id number(19,0) not null,
        begin_at timestamp,
        ebank_opened number(1,0) not null,
        end_at timestamp,
        order_limit number(10,0),
        primary key (id)
    );
    ...
    create table t_textbooks (
        ...
        award_type_id number(10,0),
        book_type_id number(10,0),
        press_id number(10,0),
        primary key (id)
    );
    ...
    create table t_theses (
        ...
        created_at timestamp,
        updated_at timestamp,
        duplicate_count number(10,0),
        duplicate_ratio float,
        uploaded number(1,0) not null,
        filename varchar2(255 char),
        subtitle varchar2(255 char),
        summary varchar2(255 char),
        title varchar2(255 char),
        off_campus_tutor_id number(19,0),
        std_id number(19,0),
        primary key (id)
    );
    ...
    create table xb_course_types (
        ...
        name varchar2(255 char),
        updated_at timestamp,
        theoretical number(1,0) not null,
        primary key (id)
    );
    ...
    alter table  cl_price_catalogs_audit_departs 
    ...
    alter table  d_thesis_notices_documents 
        ...
        references d_thesis_notices;
    alter table  d_thesis_pre_answer_actives 
    ...
    alter table  d_thesis_pre_answer_actives 
        ...
        foreign key (process) 
        references d_thesis_processes;
    alter table  d_thesis_pre_answer_filters 
        add constraint FK_le305adwwkprnu6yiqkiphpue 
        foreign key (active) 
        references d_thesis_pre_answer_actives;
    ...
    alter table  d_thesis_std_innovates 
        ...
        foreign key (ANNOTATE_ID) 
        references d_thesis_annotates;
    alter table  d_thesis_teacher_evaluations 
    ...
    alter table  d_thesis_teacher_innovates 
        ...
        foreign key (BOOK_ID) 
        references d_thesis_annotate_books;
    alter table  d_thesis_topic_open_actives 
    ...
    alter table  d_thesis_topic_open_actives 
        ...
        foreign key (process) 
        references d_thesis_processes;
    alter table  d_thesis_topic_open_filters 
        add constraint FK_anf7yig4mogoj6gwmt8m2ib9f 
        foreign key (active) 
        references d_thesis_topic_open_actives;
    ...
    alter table  d_thesis_topic_opens 
        ...
        foreign key (ACTIVE_ID) 
        references d_thesis_topic_open_actives;
    alter table  d_thesis_undergraduate_actives 
    ...
    alter table  d_thesis_undergraduate_actives 
        ...
        foreign key (process) 
        references d_thesis_processes;
    alter table  d_thesis_undergraduate_filters 
        add constraint FK_2r2jfpa5p55ol8ge4ltresbak 
        foreign key (active) 
        references d_thesis_undergraduate_actives;
    ...
    alter table  sys_student_documents_std_types 
    ...
    create sequence seq_d_thesis_pre_answer_actives start with 1 increment by 1;
    create sequence seq_d_thesis_pre_answer_filters start with 1 increment by 1;
    ...
    create sequence seq_d_thesis_teacher_evaluations start with 1 increment by 1;
    create sequence seq_d_thesis_teacher_innovates start with 1 increment by 1;
    create sequence seq_d_thesis_topic_open_actives start with 1 increment by 1;
    create sequence seq_d_thesis_topic_open_filters start with 1 increment by 1;
    ...
    create sequence seq_d_thesis_undergraduate_actives start with 1 increment by 1;
    create sequence seq_d_thesis_undergraduate_filters start with 1 increment by 1;
